...
/**
 * Two-step onboarding form. The "Complete setup" submit is single-flight —
 * a re-entrant click while a submit is in flight is dropped on the floor
 * (audit Ch10-W021). Combined with the server-side `409 already exists`
 * check this prevents a refresh-or-double-click from creating two partner
 * rows.
 */
      ...
      <div className="w-full max-w-lg">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center mb-4">
            <svg className="w-14 h-14" viewBox="0 0 64 64" fill="none" aria-hidden="true">
              <defs>
          ...
          <h1 id={titleId} className="text-2xl font-bold text-white">
