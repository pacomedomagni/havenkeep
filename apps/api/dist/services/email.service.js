...
class EmailService {
    ...
    static async sendGiftActivationEmail(data) {
        try {
            const { to, homebuyer_name, partner_name, partner_company, premium_months, activation_url, activation_code, custom_message, brand_color: rawColor = '#3B82F6', logo_url: rawLogoUrl, } = data;
