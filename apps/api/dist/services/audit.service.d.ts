...
export type AuditAction = 'auth.login' | 'auth.logout' | 'auth.logout_all' | 'auth.register' | 'auth.password_reset_request' | 'auth.password_reset_complete' | 'auth.email_verify' | 'auth.token_refresh' | 'auth.oauth_login' | 'user.create' | 'user.update' | 'user.delete' | 'user.plan_upgrade' | 'user.plan_downgrade' | 'user.email_change_requested' | 'item.create' | 'item.update' | 'item.delete' | 'item.archive' | 'item.unarchive' | 'item.transfer' | 'item.export' | 'home.create' | 'home.update' | 'home.delete' | 'document.upload' | 'document.delete' | 'document.view' | 'admin.user_impersonate' | 'admin.user_delete' | 'admin.partner_approve' | 'admin.partner_reject' | 'admin.settings_change' | 'partner.gift_create' | 'partner.gift_update' | 'partner.gift_activate' | 'partner.warranty_create' | 'partner.warranty_update' | 'security.unauthorized_access' | 'security.rate_limit_exceeded' | 'security.suspicious_activity' | 'security.api_key_used' | 'system.error' | 'system.maintenance_start' | 'system.maintenance_end';
