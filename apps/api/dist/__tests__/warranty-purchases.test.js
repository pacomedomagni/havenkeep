...
describe('Warranty Purchases API - /api/v1/warranty-purchases', () => {
    ...
    describe('GET /api/v1/warranty-purchases', () => {
        ...
        it('should list purchases after creation', async () => {
            ...
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'Dishwasher' });
        ...
        it('should filter purchases by status', async () => {
            const { user, token } = await (0, helpers_1.createTestUser)();
            const home = await (0, helpers_1.createTestHome)(user.id);
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'Dryer' });
            ...
            const activeRes = await (0, supertest_1.default)(app)
            ...
            const cancelledRes = await (0, supertest_1.default)(app)
    ...
    describe('POST /api/v1/warranty-purchases', () => {
        it('should create a purchase successfully (201)', async () => {
            const { user, token } = await (0, helpers_1.createTestUser)();
            const home = await (0, helpers_1.createTestHome)(user.id);
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'Oven' });
            const res = await (0, supertest_1.default)(app)
                .post('/api/v1/warranty-purchases')
                .set('Authorization', `Bearer ${token}`)
                .send({
    ...
    describe('GET /api/v1/warranty-purchases/active', () => {
        it('should get active coverage', async () => {
            const { user, token } = await (0, helpers_1.createTestUser)();
            const home = await (0, helpers_1.createTestHome)(user.id);
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'Microwave' });
            await (0, supertest_1.default)(app)
                .post('/api/v1/warranty-purchases')
                .set('Authorization', `Bearer ${token}`)
                .send({
    ...
    describe('GET /api/v1/warranty-purchases/quotes', () => {
        it('should return quotes for a valid item', async () => {
            const { user, token } = await (0, helpers_1.createTestUser)();
            const home = await (0, helpers_1.createTestHome)(user.id);
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'TV', price: 800 });
            const res = await (0, supertest_1.default)(app)
    ...
    describe('GET /api/v1/warranty-purchases/:id', () => {
        it('should get a single purchase by ID', async () => {
            const { user, token } = await (0, helpers_1.createTestUser)();
            const home = await (0, helpers_1.createTestHome)(user.id);
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'Washer' });
            const createRes = await (0, supertest_1.default)(app)
                .post('/api/v1/warranty-purchases')
                .set('Authorization', `Bearer ${token}`)
                .send({
        ...
        it('should reject access to another user\'s purchase (404)', async () => {
            const userA = await (0, helpers_1.createTestUser)({ email: 'purchaseusera@test.com' });
            const userB = await (0, helpers_1.createTestUser)({ email: 'purchaseuserb@test.com' });
            const homeB = await (0, helpers_1.createTestHome)(userB.user.id);
            const itemB = await (0, helpers_1.createTestItem)(userB.user.id, homeB.id);
            const createRes = await (0, supertest_1.default)(app)
                .post('/api/v1/warranty-purchases')
    ...
    describe('POST /api/v1/warranty-purchases/:id/cancel', () => {
        it('should cancel a purchase', async () => {
            const { user, token } = await (0, helpers_1.createTestUser)();
            const home = await (0, helpers_1.createTestHome)(user.id);
            const item = await (0, helpers_1.createTestItem)(user.id, home.id, { name: 'Furnace' });
            const createRes = await (0, supertest_1.default)(app)
                .post('/api/v1/warranty-purchases')
                .set('Authorization', `Bearer ${token}`)
                .send({
...
//# sourceMappingURL=warranty-purchases.test.js.map