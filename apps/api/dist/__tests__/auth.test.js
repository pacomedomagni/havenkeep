...
describe('Auth API', () => {
    ...
    describe('POST /api/v1/auth/register', () => {
        ...
        it('should reject duplicate email registration', async () => {
            await (0, helpers_1.createTestUser)({ email: 'dup@test.com' });
            const res = await (0, supertest_1.default)(app)
                .post('/api/v1/auth/register')
                .send({
                email: 'dup@test.com',
    ...
    describe('POST /api/v1/auth/login', () => {
        it('should login successfully with correct credentials', async () => {
            ...
            await (0, helpers_1.createTestUser)({ email: 'login@test.com', password: 'StrongPass1!' });
            const res = await (0, supertest_1.default)(app)
        ...
        it('should reject login with wrong password', async () => {
            await (0, helpers_1.createTestUser)({ email: 'wrongpw@test.com', password: 'StrongPass1!' });
            const res = await (0, supertest_1.default)(app)
                .post('/api/v1/auth/login')
                .send({
        ...
        it('should be case-insensitive for email', async () => {
            await (0, helpers_1.createTestUser)({ email: 'CaseTest@test.com', password: 'StrongPass1!' });
            const res = await (0, supertest_1.default)(app)
                .post('/api/v1/auth/login')
                .send({
    ...
    describe('POST /api/v1/auth/refresh', () => {
        it('should issue new tokens with a valid refresh token', async () => {
            ...
            await (0, helpers_1.createTestUser)({ email: 'refresh@test.com', password: 'StrongPass1!' });
        ...
        it('should reject a reused refresh token', async () => {
            ...
            await (0, helpers_1.createTestUser)({ email: 'reuse@test.com', password: 'StrongPass1!' });
            const loginRes = await (0, supertest_1.default)(app)
                .post('/api/v1/auth/login')
