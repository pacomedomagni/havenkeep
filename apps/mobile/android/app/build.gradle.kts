...
// Read signing credentials from key.properties (gitignored). Falls back to
// debug signing if absent so a fresh checkout still builds.
...
android {
    namespace = "app.havenkeep.mobile"
    ...
    defaultConfig {
        applicationId = "app.havenkeep.mobile"
