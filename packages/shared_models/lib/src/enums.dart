...
enum ItemCategory {
  ...
  String get displayLabel => switch (this) {
        ...
        ItemCategory.air_purifier => 'Air Purifier',
        ItemCategory.vacuum => 'Vacuum',
        ItemCategory.ceiling_fan => 'Ceiling Fan',
        ItemCategory.smoke_detector => 'Smoke Detector',
        ItemCategory.security_system => 'Security System',
        ItemCategory.garage_door_opener => 'Garage Door Opener',
        ItemCategory.power_tools => 'Power Tools',
        ItemCategory.lawn_mower => 'Lawn Mower',
        ItemCategory.pool_equipment => 'Pool Equipment',
        ItemCategory.grill => 'Grill',
        ItemCategory.coffee_maker => 'Coffee Maker',
        ItemCategory.home_theater => 'Home Theater',
        ItemCategory.printer => 'Printer',
        ItemCategory.networking => 'Networking',
        ItemCategory.camera => 'Camera',
        ItemCategory.lighting => 'Lighting',
        ItemCategory.dehumidifier => 'Dehumidifier',
        ItemCategory.freezer => 'Freezer',
        ItemCategory.wine_cooler => 'Wine Cooler',
        ItemCategory.trash_compactor => 'Trash Compactor',
...
enum NotificationType {
  ...
  String get displayLabel => switch (this) {
        ...
        NotificationType.maintenance_due => 'Maintenance Due',
        NotificationType.claim_update => 'Claim Update',
        NotificationType.claim_opportunity => 'Claim Opportunity',
